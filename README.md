...
![npm](https://img.shields.io/npm/v/ai-cover-letter)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-cover-letter)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Professional cover letter generation tool for job applications

Professional cover letter generator. Creates tailored application letters from job descriptions.

[![npm version](https://img.shields.io/npm/v/ai-cover-letter.svg)](https://www.npmjs.com/package/ai-cover-letter)
[![npm downloads](https://img.shields.io/npm/dm/ai-cover-letter.svg)](https://www.npmjs.com/package/ai-cover-letter)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-cover-letter)](https://github.com/lxgicstudios/ai-cover-letter/stargazers)
